...
const content = [
  {
    title: "Lend Your Assets, Keep Your Keys",
    bg: colors.primary,
    fontColor: colors.textprimary,
  },
  {
    title: "Next-Gen Security, One Click Away",
    bg: colors.textsecondary,
    fontColor: colors.textprimary,
  },
  {
    title: "From Fragments to Freedom",
    bg: colors.accent,
    fontColor: colors.textprimary,
  },
  {
    title: "Own Your Keys, Own Your Future",
    bg: colors.success,
    fontColor: colors.textprimary,
  },
  {
    title: "Web3 Simplified, Secrets Fortified",
    bg: colors.danger,
    fontColor: colors.textprimary,
  },
];
